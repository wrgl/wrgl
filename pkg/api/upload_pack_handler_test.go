...
func TestUploadPack(t *testing.T) {
	...
	apitest.RegisterHandler(http.MethodPost, api.PathUploadPack, apiserver.NewUploadPackHandler(db, rs, apiserver.NewUploadPackSessionMap(), 0))
...
func TestUploadPackMultiplePackfiles(t *testing.T) {
	...
	apitest.RegisterHandler(http.MethodPost, api.PathUploadPack, apiserver.NewUploadPackHandler(db, rs, apiserver.NewUploadPackSessionMap(), 1024))
