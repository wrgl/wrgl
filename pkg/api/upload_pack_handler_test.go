...
func TestUploadPack(t *testing.T) {
	...
	apitest.RegisterHandler(http.MethodPost, "/upload-pack/", NewUploadPackHandler(db, rs, 0))
...
func TestUploadPackMultiplePackfiles(t *testing.T) {
	...
	apitest.RegisterHandler(http.MethodPost, "/upload-pack/", NewUploadPackHandler(db, rs, 1024))
