...
func TestUploadPack(t *testing.T) {
	...
	apitest.RegisterHandler(http.MethodPost, PathUploadPack, NewUploadPackHandler(db, rs, NewUploadPackSessionMap(), 0))
...
func TestUploadPackMultiplePackfiles(t *testing.T) {
	...
	apitest.RegisterHandler(http.MethodPost, PathUploadPack, NewUploadPackHandler(db, rs, NewUploadPackSessionMap(), 1024))
