...
func TestNegotiatorHandleUploadPackRequest(t *testing.T) {
	...
	objects.AssertCommitEqual(t, c1, commits[2])
	objects.AssertCommitEqual(t, c6, commits[3])
	objects.AssertCommitEqual(t, c4, commits[4])
	objects.AssertCommitEqual(t, c2, commits[5])
